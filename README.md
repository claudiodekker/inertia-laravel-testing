...
> **NOTE**: This package will become part of [inertiajs/inertia-laravel](https://github.com/inertiajs/inertia-laravel) on **March 1st, 2021**, with upgrading only taking one or two minutes at max. Once this happens, this package WILL remain available for installation, but WILL NOT receive any further (security) updates going forward.
